...
public class HibernateSessionFactory {
    ...
    static {
        try {
            ...
            InputStream inputStream = HibernateSessionFactory.class.getClassLoader().getResourceAsStream("hibernate.properties");
            properties.load(inputStream);
            configuration.setProperties(properties);
            configuration.addResource("com/jimisun/domain/User.hbm.xml");
